...
export default function MusicPage() {
  return (
    <main className="music-surface min-h-screen flex flex-col overflow-hidden">
      <header className="absolute top-0 left-0 right-0 flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 z-10">
        <a
          href="/"
          className="text-white/30 hover:text-white/60 transition-colors text-[9px] sm:text-[10px] uppercase tracking-[0.15em] debug-mono"
        >
          ← Return
        </a>
        <span className="text-white/15 text-[8px] sm:text-[9px] uppercase tracking-[0.2em] debug-mono">
